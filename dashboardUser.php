...
<p>Poser une Question</p>
            ...
            <main class="w-full flex flex-col p-6 hidden" id = "QuestionsTable">
                ...
                <div class="flex items-center mb-4">
                    <span
                        class="text-sm font-semibold text-blue-500 bg-blue-100 rounded-full px-3 py-1 mr-2">html</span>
                    <span
                        class="text-sm font-semibold text-green-500 bg-green-100 rounded-full px-3 py-1 mr-2">tailwind-css</span>
                </div>
                ...
                <div class="mt-4 flex items-center space-x-4">
                    <button
                        class="flex items-center text-gray-500 hover:text-blue-500 focus:outline-none">
            ...
            <main class="w-full flex flex-col p-6 hidden" id = "SectionTable">
                ...
                <!-- <h1 class="text-3xl text-black pb-6 col-span-3 py-4">8 answers</h1>

                <div class = "w-full bg-blue-100 rounded">
                    <div class = "bg-blue-500 w-full rounded">
                        <p class = "text-xl text-white pl-8"><i class="fa-solid fa-circle-check mr-2"></i>SOLUTION</p>
                    </div>
                    <div class = "flex flex-row p-4">
                        <div class = "flex flex-col text-center w-3/6 border-r pr-4 border-gray-500">
                            <img src="./img/abdellah.png" alt="" class = "rounded">
                            <p class = "font-bold text-blue-500 pt-2">Abdellah Talemsi</p>
                            <p class = "text-gray-500 text-sm"><i class = "fa-solid fa-user mr-2"></i>User</p>
                        </div>
                ...
                <div class = "w-full bg-white rounded border-t border-gray-500 mt-8">
                    <div class = "flex flex-row p-4">
                        <div class = "flex flex-col text-center w-3/6 border-r pr-4 border-gray-500">
                            <img src="./img/imad.png" alt="" class = "rounded">
                            <p class = "font-bold text-blue-500 pt-2">Imadeddine Saghir</p>
                            <p class = "text-gray-500 text-sm"><i class = "fa-solid fa-user mr-2"></i>User</p>
                        </div>
                        <div class = "flex flex-col ml-2 justify-between">
                            <p class = "text-sm text-blue-700 mb-2">Apr 22, 2018</p>
