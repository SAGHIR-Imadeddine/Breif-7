            ...
            <main>
                <div class="bg-gray-100">
                    <div class="w-full mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class=" flex justify-evenly  items-center  flex-wrap" id="nbrquestion">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($projectsResult->num_rows > 0) {
                            while ($projectsData = $projectsResult->fetch_assoc()) {
                                ...
                                echo '<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow teamSelect transition-all" data-id="'. $projectsData['id_project'] .'">';
                                echo '<a href="#">';
                                echo "<img class='rounded-t-lg' src='$projectsImg' alt='' />";
                                echo '</a>';
                                echo '<div class="p-5">';
